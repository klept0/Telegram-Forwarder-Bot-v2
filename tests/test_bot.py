...
class TestBot:
    ...
    @pytest.mark.asyncio
    async def test_bot_start_success(self, mock_telegram_client, mock_credentials):
        ...
        with (
            ...
            patch("source.model.Credentials.Credentials.get") as mock_creds_get,
            ...
            mock_telegram_create.return_value = mock_telegram_client

            mock_selector = MagicMock()
            mock_selector.select_account = AsyncMock(return_value=mock_telegram_client)
